const generation = (e) => { //FUNCION GENERACION DE ACUERDO A LA SEDE SELECCIONADA
	...
	let keys = Object.keys(data[valor]['generacion']);//obtenemos los keys del objeto data[valor]['generacion'] los cuales son keys = [cuarta,quinta,tercera]
...
const students = (e) => {
	...
	let estudiantes = data[valor]['generacion'][generation]['estudiantes'];//obtenemos el objeto basandonos en la informacion obtenida y accediendo a los keys ejmplo data[mexico]['generacion'][cuarta]['estudiantes']
